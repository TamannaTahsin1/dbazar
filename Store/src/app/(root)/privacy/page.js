...
function Privacy(props) {
  return (
    <div>
      <section>
        <Cover coverHeading={"Privacy Policy"}></Cover>
      </section>
      <Container>
        <div className="my-20 space-y-4">
          <h5>Last updated: February 15, 2022</h5>
          <p>
          ...
          <p>
            ...
            updates and other information. <br /> 2. Improve, personalize, and
            expand our website,and other information relating to the website.{" "}
            <br /> 3. Understand and analyze how you use our website, to provide
            you with updates and other information relating to the website.{" "}
            <br /> 4. Develop new products, services, features, and
            functionality,and other information relating to the website. <br />{" "}
            5. Communicate with you, either directly or through one of our
            partners, including for customer service, to provide you with
            updates. <br /> 6. Send you emails. To provide you with updates and
            other information relating to the website, and for marketing and
            promotional purposes. <br /> 7. Find and prevent fraud. To provide
          ...
          <p>
            ...
            appear on KachaBazar, which are sent directly to users browser. They
          ...
          <h4 className="font-semibold">Third Party Privacy Policies</h4>
          <p>
