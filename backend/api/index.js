...
//root route
app.get("/", (req, res) => {
  res.send("Backend Workings Properly!");
});
...
//this endpoints needs to be authentication...due to test purpose i have vommented this
...
//without auth endpoint (for testing purposes)
...
//       "http://localhost:3000",
//       "http://localhost:4100",
//       "https://admin-D-Bazar.vercel.app",
